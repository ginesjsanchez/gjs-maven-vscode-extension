...
export class MavenOptionsView implements vscode.WebviewViewProvider {
    public static readonly viewId = 'mavenOptions';
    private webviewView?: vscode.WebviewView;

    constructor(
        private readonly context: vscode.ExtensionContext,
        private readonly optionsManager: MavenOptionsManager
    ) {}
    ...
    refresh(): void {
        if (this.webviewView?.visible) { this.sendState(); }
    }
